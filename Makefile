...
OFILES = mylib.o main.o font.o croco.o snake.o home.o frogger.o lose.o lo.o st.o pos.o winner.o up.o left.o down.o right.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h croco.h  snake.h home.h frogger.h lose.h lo.h st.h pos.h winner.h up.h left.h down.h right.h
